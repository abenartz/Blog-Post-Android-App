...
import com.example.blogposts.util.Constants.Companion.GALLERY_REQUEST_CODE
import com.example.blogposts.util.ErrorHandling.Companion.ERROR_MUST_SELECT_IMAGE
import com.example.blogposts.util.ErrorHandling.Companion.ERROR_SOMETHING_WRONG_WITH_IMAGE
import com.example.blogposts.util.SuccessHandling.Companion.SUCCESS_BLOG_CREATED
...
class CreateBlogFragment : BaseCreateBlogFragment(){
    ...
    private fun subscribeObservers() {
        ...
        viewModel.viewState.observe(viewLifecycleOwner, Observer { createBlogViewState ->
            createBlogViewState.blogFields.let { newBlogFields ->
                setBlogProperties(
                    newBlogFields.newBlogTitle,
                    newBlogFields.newBlogBody,
                    newBlogFields.newBlogUri
                )
            }
        })
    }
